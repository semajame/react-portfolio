        ...
        <div className='rounded-lg dark sm:p-2 p-1 mt-5 transition-all duration-300 border border-zinc-800 bg-black'>
          <div className='sm:my-5 my-2 text-sm text-white sm:p-5 p-2'>
            <div className='text-xs border border-black p-2 bg-zinc-900 rounded-md'>
              ...
              <p className='text-md'>jamesanquillano@gmail.com</p>
            </div>
            <div className='text-xs border border-black p-2 bg-zinc-900 rounded-md mt-3'>
              <h1 className='text-sm font-bold'>Phone Number</h1>
              <p className='text-md'>09369533064</p>
            </div>
            <h1 className='text-sm font-bold mt-3'>Socials</h1>
            <div className='text-xs flex items-center gap-2 mt-2'>
              <a
                href='https://www.linkedin.com/in/james-anquillano-47b001263/'
                target='_blank'
                aria-label='Visit LinkedIn profile'
                className='border-black p-2 rounded-md bg-zinc-900 transition-all duration-200'
              >
                <svg
                  className='w-5 h-5'
                  fill='currentColor'
